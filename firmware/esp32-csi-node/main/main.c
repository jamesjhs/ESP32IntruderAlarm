...
static esp_err_t root_get_handler(httpd_req_t *req)
{
    static const char page[] =
        ...
        "<label class=\"control\"><span>Raspberry Pi Port</span><b id=\"ppv\">1000</b><input id=\"pp\" type=\"number\" min=\"1\" max=\"65535\" step=\"1\"></label>"
        "<label class=\"control\"><span>Pi API Address</span><b id=\"pav\">http://{pi-IP-address}:1000/espdata</b><input id=\"pa\" type=\"text\" placeholder=\"/espdata\"></label>"
        ...
        "<dt>Raspberry Pi Port</dt><dd>The Pi HTTP port for the receiving API. The default is 1000.</dd>"
